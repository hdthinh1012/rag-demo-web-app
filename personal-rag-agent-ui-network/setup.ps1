...
docker run -d --name personal-rag-agent-ui-nginx-sidecar --network personal-rag-agent-ui-network -p 81:80 hdthinh1012/personal-rag-agent-ui-nginx-sidecar:latest